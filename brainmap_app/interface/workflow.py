...
from brainmap_app.ml_logic.params import CNN_MODEL_PATH, YOLO_MODEL_PATH, CLASS_MAPPING, IMAGE_SIZE
from brainmap_app.ml_logic.preprocessor import normalize_mri
...
def predict(image):
    ...
    shap_image_path = './brainmap_app/static/shap_image.png'
    plt.imshow(shap_values[0].values[0], cmap='coolwarm')
    plt.axis('off')
    plt.savefig(shap_image_path)

    yolo_image_path = './brainmap_app/static/yolo_detection.png'
